...
async function renderCars() {
    ...
    if (cars.length > 1) {
        ...
        prev.innerHTML = `<img src="media/icons/free-icon-right-arrow-271228.png" style="transform: rotate(180deg); width: 36px; height: 36px;" alt="Назад">`;
        prev.onclick = () => {
        ...
        next.innerHTML = `<img src="media/icons/free-icon-right-arrow-271228.png" style="width: 36px; height: 36px;" alt="Вперед">`;
        next.onclick = () => {
